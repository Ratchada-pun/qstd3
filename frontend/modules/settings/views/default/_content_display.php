...
<?= Datatables::widget([
    ...
    'clientOptions' => [
        'ajax' => [
            'url' => Url::base(true).'/settings/default/data-display'
        ],
        "dom" => "<'pull-left'f><'pull-right'l>t<'pull-left'i>p",
        "language" => array_merge(Yii::$app->params['dtLanguage'],[
            "search" => "_INPUT_ " . Html::a(Icon::show('plus').' เพิ่ม-ลบ รายการ', ['/settings/default/create-display'],['class' => 'btn btn-success','role' => 'modal-remote']),
        ...
        'columns' => [
            ...
            ["data" => "tb_counterservice_type","className" => "dt-body-left ","title" => "Counter"],
