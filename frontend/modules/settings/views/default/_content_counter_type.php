...
<div class="panel-body">
    <?php  
    echo Table::widget([
        'tableOptions' => ['class' => 'table table-hover','width' => '100%','id' => 'tb-counter-type'],
        'beforeHeader' => [
            [
                'columns' => [
                    ['content' => 'ID','options' => []],
                    ['content' => 'ชื่อเคาน์เตอร์','options' => []],
...
<?= Datatables::widget([
    ...
    'clientOptions' => [
        'ajax' => [
            'url' => Url::base(true).'/settings/default/data-counter-type'
        ],
        "dom" => "<'pull-left'f><'pull-right'l>t<'pull-left'i>p",
        "language" => array_merge(Yii::$app->params['dtLanguage'],[
            "search" => "_INPUT_ " . Html::a(Icon::show('plus').' เพิ่ม-ลบ รายการ', ['/settings/default/create-counter-type'],['class' => 'btn btn-success','role' => 'modal-remote']),
        ...
        'columns' => [
            ...
            ["data" => "tb_counterservice_type","className" => "dt-body-left dt-head-nowrap","title" => "ชื่อเคาน์เตอร์"],
