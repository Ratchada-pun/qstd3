...
<div class="panel-body">
    <?php  
    echo Table::widget([
        'tableOptions' => ['class' => 'table table-hover','width' => '100%','id' => 'tb-doctor'],
        'beforeHeader' => [
            [
                'columns' => [
                    ['content' => 'ID','options' => []],
                    ['content' => 'ชื่อแพทย์','options' => []],
...
<?= Datatables::widget([
    ...
    'clientOptions' => [
        'ajax' => [
            'url' => Url::base(true).'/settings/default/data-doctor'
        ],
        "dom" => "<'pull-left'f><'pull-right'l>t<'pull-left'i>p",
        "language" => array_merge(Yii::$app->params['dtLanguage'],[
            "search" => "_INPUT_ " . Html::a(Icon::show('plus').' เพิ่ม-ลบ รายการ', ['/settings/default/create-doctor'],['class' => 'btn btn-success','role' => 'modal-remote']),
        ...
        'columns' => [
            ...
            ["data" => "service_md_name","className" => "dt-body-left dt-head-nowrap","title" => "ชื่อแพทย์"],
