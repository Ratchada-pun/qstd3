...
<?php $form = ActiveForm::begin([
    'id' => 'form-section', 'type' => ActiveForm::TYPE_HORIZONTAL, 
                    ...
                    <div class="panel-body">
                        <?php
                            if (! $model->isNewRecord) {
                                echo Html::activeHiddenInput($model, "[{$index}]sec_id");
                            }
                        ?>
                        <div class="form-group">
                            <?= Html::activeLabel($model, "[{$index}]sec_name", ['label' => 'ชื่อแผนก/คลีนิค','class'=>'col-sm-2 control-label']) ?>
                            <div class="col-sm-8">
                                <?= $form->field($model, "[{$index}]sec_name",['showLabels'=>false])->textInput([
                                    'placeholder' => 'ชื่อแผนก/คลีนิค'
                                ]); ?>
                            </div>
                        </div>

                        <div class="form-group">
                            <?= Html::activeLabel($model, "[{$index}]sec_firststatus", ['class'=>'col-sm-2 control-label']) ?>
                            <div class="col-sm-4">
                                <?=
                                $form->field($model, "[{$index}]sec_firststatus")->widget(Select2::classname(), [
...
//Form Event
var table = $('#tb-section').DataTable();
