...
<?php $form = ActiveForm::begin([
    'id' => 'form-service-status', 'type' => ActiveForm::TYPE_HORIZONTAL, 
                    ...
                    <div class="panel-body">
                        <?php
                            if (! $model->isNewRecord) {
                                echo Html::activeHiddenInput($model, "[{$index}]service_status_id");
                            }
                        ?>
                        <div class="form-group">
                            <?= Html::activeLabel($model, "[{$index}]service_status_name", ['label' => 'ชื่อสถานะ','class'=>'col-sm-2 control-label']) ?>
                            <div class="col-sm-8">
                                <?= $form->field($model, "[{$index}]service_status_name",['showLabels'=>false])->textInput([
...
//Form Event
var table = $('#tb-service-status').DataTable();
var \$form = $('#form-service-status');
