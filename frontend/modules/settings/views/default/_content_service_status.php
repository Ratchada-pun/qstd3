...
<div class="panel-body">
    <?php  
    echo Table::widget([
        'tableOptions' => ['class' => 'table table-hover','width' => '100%','id' => 'tb-service-status'],
        'beforeHeader' => [
            [
                'columns' => [
                    ['content' => 'ID','options' => []],
                    ['content' => 'ชื่อสถานะ','options' => []],
...
<?= Datatables::widget([
    'id' => 'tb-service-status',
    'select2' => true,
    'clientOptions' => [
        'ajax' => [
            'url' => Url::base(true).'/settings/default/data-service-status'
        ],
        "dom" => "<'pull-left'f><'pull-right'l>t<'pull-left'i>p",
        "language" => array_merge(Yii::$app->params['dtLanguage'],[
            "search" => "_INPUT_ " . Html::a(Icon::show('plus').' เพิ่ม-ลบ รายการ', ['/settings/default/create-service-status'],['class' => 'btn btn-success','role' => 'modal-remote']),
        ...
        'columns' => [
            ...
            ["data" => "service_status_name","className" => "dt-body-left dt-head-nowrap","title" => "ชื่อสถานะ"],
