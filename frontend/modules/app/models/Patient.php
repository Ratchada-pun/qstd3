...
class Patient extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['familyno', 'hn_int', 'hid', 'height', 'hospital_department_id', 'ec_relation_type_id', 'patient_color_id', 'number_of_relatives', 'birth_order', 'person_labor_type_id'], 'integer'],
            ...
            [['occupation', 'patient_type_id'], 'string', 'max' => 4],
