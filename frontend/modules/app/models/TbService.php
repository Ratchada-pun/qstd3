...
class TbService extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['service_groupid', 'prn_profileid', 'prn_copyqty', 'service_numdigit', 'service_md_name_id', 'print_by_hn', 'quickly', 'show_on_kiosk', 'show_on_mobile', 'prn_profileid_quickly','service_type_id','average_time'], 'integer'],
