...
/**
 * TbQuequSearch represents the model behind the search form of `frontend\modules\app\models\mobile\TbQuequ`.
 */
class TbQuequSearch extends TbQuequ
{
    ...
    {
        return [
            [['q_ids', 'q_arrive_time', 'q_appoint_time', 'pt_id', 'pt_visit_type_id', 'pt_appoint_sec_id', 'serviceid', 'servicegroupid', 'quickly', 'q_status_id', 'doctor_id', 'counterserviceid'], 'integer'],
            [['q_num', 'q_timestp', 'q_vn', 'q_hn', 'pt_name', 'created_at', 'updated_at'], 'safe'],
        ];
    }
