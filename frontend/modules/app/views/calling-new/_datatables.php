    ...
    echo Datatables::widget([
        ...
        'clientOptions' => [
            ...
            'columns' => [
                ...
                ["data" => "q_vn", "className" => "dt-body-center dt-head-nowrap", "title" => "VN"],
                ...
                ["data" => "lab", "className" => "dt-body-center dt-head-nowrap", "title" => "LAB"],
                ["data" => "xray", "className" => "dt-body-center dt-head-nowrap", "title" => "X-ray"],
                ["data" => "SP", "className" => "dt-body-center dt-head-nowrap", "title" => "SP"],
        ...
        'clientOptions' => [
            ...
            "drawCallback" => new JsExpression('function(settings) {
                ...
                api.column(4, {page:"current"} ).data().each( function ( group, i ) {
                    ...
                    if ( last !== group ) {
                        $(rows).eq( i ).before(
                            \'<tr class=""><td style="text-align:center;background-color:palegreen;color:black;font-size: 16px;" colspan="\'+columns.length+\'">\'+group+\'</td></tr>\'
                        );
                        last = group;
                    }
                } );
            ...
            'columns' => [
                ...
                ["data" => "q_num", "className" => "dt-body-center dt-head-nowrap", "title" => "<i class=\"fa fa-money\"></i> คิว"],
                ["data" => "q_hn", "className" => "dt-body-center dt-head-nowrap", "title" => "HN"],
                ["data" => "VN", "className" => "dt-body-center dt-head-nowrap", "title" => "VN"],
                ["data" => "service_name", "className" => "dt-body-left dt-head-nowrap", "title" => "ประเภท"],
                ["data" => "pt_name", "className" => "dt-body-left dt-head-nowrap", "title" => "<i class=\"fa fa-user\"></i> ชื่อ-นามสกุล"],
                ["data" => "checkin_date", "className" => "dt-body-center dt-head-nowrap", "title" => "<i class=\"fa fa-clock-o\"></i> เวลามาถึง"],
                ["data" => "counterservice_name", "className" => "dt-body-center dt-head-nowrap", "title" => "จุดบริการ"],
                ...
                ["data" => "SP", "className" => "dt-body-center dt-head-nowrap", "title" => "SP"],
                // ["data" => "lab_confirm", "className" => "dt-center", "title" => "ผล Lab"],
                ["data" => "pt_visit_type_id", "className" => "dt-body-center dt-head-nowrap", "title" => "สถานะผู้ป่วย"],
                ["data" => "actions", "className" => "dt-center dt-nowrap", "orderable" => false, "title" => "<i class=\"fa fa-cogs\"></i> ดำเนินการ"]
            ],
            "columnDefs" => [
                [
        ...
        'clientOptions' => [
            ...
            "drawCallback" => new JsExpression('function(settings) {
                ...
                api.column(4, {page:"current"} ).data().each( function ( group, i ) {
                    ...
                    if ( last !== group ) {
                        $(rows).eq( i ).before(
                            \'<tr class=""><td style="background-color:#87CEEB;color:black;text-align: center;font-size: 16px;" colspan="\'+columns.length+\'">\'+group+\'</td></tr>\'
                        );
                        last = group;
                    }
                } );
        ...
        'clientOptions' => [
            ...
            "drawCallback" => new JsExpression('function(settings) {
                ...
                api.column(4, {page:"current"} ).data().each( function ( group, i ) {
                    ...
                    if ( last !== group ) {
                        $(rows).eq( i ).before(
                            \'<tr class=""><td style="background-color:#FFDEAD;color:black;text-align: center;font-size: 16px;" colspan="\'+columns.length+\'">\'+group+\'</td></tr>\'
                        );
                        last = group;
                    }
                } );
