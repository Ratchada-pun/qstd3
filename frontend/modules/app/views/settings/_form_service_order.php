...
<?php $form = ActiveForm::begin([
    ...
    <div class="form-group">
	    <?= Html::activeLabel($model, 'items_sort', ['label' => 'จัดเรียง', 'class'=>'col-sm-2 control-label']) ?>
	    <div class="col-sm-6">
	        <?= $form->field($model, 'items_sort')->widget(SortableInput::classname(), [
                'items' => $items,
                'hideInput' => false,
