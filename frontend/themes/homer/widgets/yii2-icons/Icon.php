...
class Icon
{
     ...
     */
    const PARAM_NOT_SET = "The 'icon-framework' option has not been setup in Yii params. Check your configuration file. example config 'params' => ['icon-framework' => 'fa']";
    /**
    ...
    private static $_frameworks = [
        ...
        self::I => ['prefix' => '', 'class' => 'FontAwesomeAsset'],
    ];
