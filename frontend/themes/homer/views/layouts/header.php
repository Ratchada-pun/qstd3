...
<div id="header">
    ...
    <div id="logo" class="light-version" style="padding:12px ;">
        <?= Html::a(Html::img(\Yii::$app->keyStorage->get('logo-url', '/img/logo/logoKM4.png'),['class' => 'img-responsive center-block','width' => '50px',]),Url::to(['/site/index']),['style' => 'text-transform: uppercase']); ?>
        <!-- <span>
            Homer Theme
        </span> -->
    </div>
