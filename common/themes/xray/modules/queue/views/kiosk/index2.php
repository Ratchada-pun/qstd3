  ...
  <section v-if="!action" class="section-home">
    ...
    <div class="row">
      <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="col-md-9 col-lg-3" style="padding-top: 30px;text-align: -webkit-right;">
          <!-- <button type="button" class="btn btn-outline-info  rounded-pill mb-3" data-toggle="button" aria-pressed="false" autocomplete="off" id="change language">
              English
          </button> -->
          ...
          <div class="custom-control custom-switch custom-switch-text custom-control-inline">
            <div class="custom-switch-inner">
              ...
              <label class="custom-control-label" for="customSwitch-11" data-on-label="Thai" data-off-label="English">
              </label>
            </div>
          </div>
        </div>
