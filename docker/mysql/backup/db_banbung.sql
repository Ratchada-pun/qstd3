...
INSERT INTO `tb_counterservice` VALUES (8, 'ห้องเจาะเลือด 1', NULL, 3, NULL, NULL, 2, 1, 1, '1', 'Prompt1', 1, 'Prompt1_Service.wav');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (2, 'admin', 'admin-banbung@qsystem.com', '$2y$12$/cRo6GQyHmT6gufgQ13BK.Uwck0dW.NdCM55XRq5rB56Pm2kKdpFm', 's59qUPZ27CxgPEaNgLw71CrygQD5Ni3x', 1517979470, NULL, NULL, '127.0.0.1', 1517979470, 1517979470, 0, 1519543201);
